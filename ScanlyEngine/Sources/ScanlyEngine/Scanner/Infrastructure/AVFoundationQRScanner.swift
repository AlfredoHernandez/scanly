...
@MainActor
public final class AVFoundationQRScanner: QRScanning, CameraPreviewProviding, TorchControlling, CameraControlling {
	...
	public func setRegionOfInterest(_ layerRect: CGRect) {
	...
	public func focus(at layerPoint: CGPoint) {
