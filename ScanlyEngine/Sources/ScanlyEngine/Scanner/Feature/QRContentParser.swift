...
public nonisolated protocol QRContentParsing: Sendable {
	func parse(_ content: String) -> QRType
}

public nonisolated struct QRContentParser: QRContentParsing {
	public init() {}
	...
	public func parse(_ content: String) -> QRType {
